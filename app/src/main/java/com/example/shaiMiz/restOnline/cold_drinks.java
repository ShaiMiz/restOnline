...
public class cold_drinks extends AppCompatActivity {
    ListView listView;
    Integer[] imageId = {
            R.drawable.c1,
            R.drawable.c2,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getJSON("http://192.168.1.59/php/gettable3.php");
    }
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        CustomList adapter = new CustomList(cold_drinks.this, itemName, imageId);
        listView = findViewById(R.id.listView);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Toast.makeText(cold_drinks.this, "You Clicked at " +itemName[+ position], Toast.LENGTH_SHORT).show();
